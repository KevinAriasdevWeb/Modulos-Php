...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <ul class="navbar-nav ml-auto">
        <ul class="navbar-nav ml-auto">
            <form action="buscador-registro-llamadas2.php" method="POST" class="form-inline my-2 my-lg-0">
            <select name="campoSeleccionado" class="form-control mr-sm-2" >
                ...
                <option value="entusiasmo_percibido">Entusiasmo</option>
                <option value="Npreguntas_feedback">Nº preguntas</option>
                <option value="Comenta_experiencia">Comenta su experiencia</option>
                <option value="actitud_usuario">Actitud</option>
                <option value="percepcion_propuesta_valor">Propuesta Valor</option>
                <option value="percepcion_costo">Percepcion Costo</option>
              ...
              <button class="btn btn-success my-2 my-sm-0  mr-sm-2" value="1" name="buscar" type="submit">
                Search
            </button>
            <button name="mostrar_todo"  class="btn btn-primary my-2 my-sm-0 " type="submit">
                Mostrar todo
            </button>
...
if($result->num_rows > 0){
    ...
    $salida.="</tbody></table>";
    echo 'Numero de total de registros: ';
