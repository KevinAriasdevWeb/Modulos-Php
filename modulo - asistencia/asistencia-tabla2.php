    ...
    <div class="row m-0 justify-content-center">
        ...
        <table class="table">
            <thead class="thead-light">
                <tr>
                <form method="POST" action="asistencia-tabla2.php">
            ...
            ?>
                <tbody>
                    <tr>	<td><?php echo $contador;?></td>
                            ...
                            <td><input type="checkbox" id="asistencias[]" name="asistencias[]" value="<?php echo $mostrar['codigo_matricula'];?>"></td>
...
**/
    ...
    ?>
            <script type="text/javascript">
                ...
                setTimeout(function() {
                    window.location.href = "asistencia-tabla2.php";
                }, 1000);
            </script>
