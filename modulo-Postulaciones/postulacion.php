...
?>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <ul class="navbar-nav ml-auto">
            <ul class="navbar-nav ml-auto">
                <form action="postulacion.php" method="POST" class="form-inline my-2 my-lg-0">
                    ...
                    <button class="btn btn-success my-2 my-sm-0  mr-sm-2" value="" name="mostrar_todo" type="button" onclick='window.location.href="postulacion.php"'>
                        Mostrar Todo
                    </button>
                </form>
            </ul>
				...
				#if(!is_null($campoBusqueda) && !is_null($patronBusqueda)) 
				{
                    ...
                    if ($result2) {
                        ...
                        while ($fila2 = $result2->fetch_assoc()) {
                            ...
                            if ($contador2 >= ($paginaActual2 * $ofertas_paginas2  )   && $contador2 +1<= ($paginaActual2 * $ofertas_paginas2 ) + $ofertas_paginas2) {
                        ...
                        <nav aria-label='Page navigation example'>
                            <ul class='pagination'>
                                <li class='page-item <?php echo $_GET['pagina_busqueda'] <= 1 ? 'disabled' : '' ?>'>
                                    <a class='page-link' href='postulacion.php?<?php echo $filtro;?>pagina_busqueda=<?php echo $paginaActual2 - 1  ?>'>
                                        Anterior
                                    </a>
                                </li>
                                ...
                                <?php for ($i = 0; $i < $paginas2; $i++) { ?>
                                    <li class='page-item <?php echo $_GET['pagina_busqueda'] == $i + 1 ? 'active' : '' ?>'>
                                        <a class='page-link' href='postulacion.php?<?php echo $filtro;?>pagina_busqueda=<?php echo $i + 1 ?>'>
                                            <?php echo $i + 1 ?>
                                        </a>
                                    </li>
                                <?php } ?>
